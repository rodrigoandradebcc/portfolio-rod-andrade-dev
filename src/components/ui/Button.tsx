...
const variantStyles: Record<NonNullable<ButtonProps['variant']>, string> = {
  primary:
    'border-emerald-300/30 bg-emerald-400 text-zinc-950 shadow-[inset_0_1px_0_rgba(255,255,255,0.22),0_18px_40px_rgba(16,185,129,0.16)] hover:-translate-y-0.5 hover:brightness-105',
  secondary:
